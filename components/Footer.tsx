      ...
      <div className={styles.container}>
        <div className={styles.grid}>
          ...
          <div className={styles.column}>
            <h3 className={styles.logo}>Pusat Springbed Bogor</h3>
            <p className={styles.description}>
              Solusi profesional untuk perbaikan dan perawatan kasur Anda.
              Menghadirkan kenyamanan tidur yang lebih baik dengan layanan
              berkualitas.
            </p>
            {/* Social Media */}
          ...
          <div className={styles.column}>
            ...
            <ul className={styles.contactList}>
              ...
              <li className={styles.contactItem}>
                ...
                <a href="tel:+62XXXXXXXXXXX">+62 XXX XXXX XXXX</a>
              </li>
              <li className={`${styles.contactItem} ${styles.whatsappLink}`}>
                <svg fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className={styles.column}>
            ...
            <div className={styles.mapWrapper}>
              <iframe
                ...
                title="Pusat Springbed Bogor Location"
              ></iframe>
            </div>
          </div>
        </div>
        ...
        <div className={styles.bottomBar}>
          <div className={styles.bottomContent}>
            <p className={styles.copyright}>
              &copy; {new Date().getFullYear()} Pusat Springbed Bogor. All
              rights reserved.
            </p>
